 ...
 */
final class ResolutionH7Q6E implements ResolutionInterface
{
    use ResolutionInterfaceTrait;
}

/**
 * @author Paweł Tomulik <pawel@tomulik.pl>
 *
 * @covers \Tailors\Lib\Injector\ResolutionInterfaceTrait
 *
 * @internal this class is not covered by backward compatibility promise
 *
 * @psalm-internal Tailors\Lib\Injector
 */
final class ResolutionInterfaceTest extends TestCase
{
    use ImplementsInterfaceTrait;

    public static function createDummyInstance(): ResolutionH7Q6E
    {
        return new ResolutionH7Q6E();
    }
    ...
    public function testDummyImplementation(): void
    {
        ...
        $this->assertImplementsInterface(ResolutionInterface::class, $dummy);
    }
