...
htmlhelp_basename = 'PhpTailorsLibrariesdoc'
...
latex_documents = [
    (master_doc, 'PhpTailorsLibraries.tex', 'PhpTailors Libraries Documentation',
...
man_pages = [
    (master_doc, 'phptailorslibraries', 'PhpTailors Libraries Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PhpTailorsLibraries', 'PhpTailors Libraries Documentation',
     author, 'PhpTailorsLibraries', 'One line description of project.',
     'Miscellaneous'),
]
